...
class AuditEventTest {
    ...
    static Object[][] scenarios() {
        return new Object[][] {
            ...
            { "Null account",        null,        ACTOR, null,      AuditEventName.CREATION_DATAHUB_CLUSTER, Crn.Service.IAM,        "F94E78AE-EF50-4DCE-A871-3F9A3CCB7E14", null,       null,      false, IllegalArgumentException.class, "Account ID name must be provided."                                           },
            { "Empty account",       "",          ACTOR, null,      AuditEventName.CREATION_DATAHUB_CLUSTER, Crn.Service.IAM,        "F94E78AE-EF50-4DCE-A871-3F9A3CCB7E14", null,       null,      false, IllegalArgumentException.class, "Account ID name must be provided."                                           },
            { "Null actor",          "accountId", null,  null,      AuditEventName.CREATION_DATAHUB_CLUSTER, Crn.Service.IAM,        "F94E78AE-EF50-4DCE-A871-3F9A3CCB7E14", null,       null,      false, NullPointerException.class,     null                                                                          },
            ...
            { "Invalid ID",          "accountId", ACTOR, null,      AuditEventName.CREATION_DATAHUB_CLUSTER, Crn.Service.IAM,        "x",                                    null,       null,      false, IllegalArgumentException.class, "ID must be a valid UUID."                                                    },
            { "Valid",               "accountId", ACTOR, null,      AuditEventName.CREATION_DATAHUB_CLUSTER, Crn.Service.IAM,        "F94E78AE-EF50-4DCE-A871-3F9A3CCB7E14", null,       null,      true,  null,                           null                                                                          },
            { "Valid Null ID",       "accountId", ACTOR, null,      AuditEventName.CREATION_DATAHUB_CLUSTER, Crn.Service.IAM,        null,                                   null,       null,      true,  null,                           null                                                                          },
            { "Valid Empty ID",      "accountId", ACTOR, null,      AuditEventName.CREATION_DATAHUB_CLUSTER, Crn.Service.IAM,        "",                                     null,       null,      true,  null,                           null                                                                          },
        };
    }
    // CHECKSTYLE:ON
    // @formatter:on
